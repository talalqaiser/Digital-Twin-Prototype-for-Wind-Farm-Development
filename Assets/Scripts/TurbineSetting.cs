...
public class TurbineSetting : MonoBehaviour
{
    ...
    public float WindOutPut;
    public float RPM, windDirection;
    private TextMeshPro BarText;
    public Text text_Output;
    public static string Title_GUI;
    
    public static float WindOutputValue;
    public static float RPMValue, WindDirectionValue, WindSpeedValue, BladeLengthValue;
    //public KeyCode _key;
    ...
    private void Start()
    {
        ...
        BladeLength = 75; HubLength = 2.0f; Cp = 4;
    ...
    void indicator()
    {
        ...
        text_Output.text = ((WindOutPut / 100000).ToString("0.00") + " MW");
